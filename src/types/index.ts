...
export interface Contact {
  ...
  user_id: string;
  account_id: string;
  /** Null desde la migración 060: un contacto puede identificarse solo
   *  por su BSUID cuando Meta no nos manda el teléfono. */
  phone: string | null;
  /** Digits-only form of `phone`, generated by the DB (migration 022)
   *  and unique per account. Read-only. Null si no hay teléfono. */
  phone_normalized?: string | null;
  /** BSUID de Meta (`CC.<alfanum>`), único por cuenta (migración 060). */
  wa_user_id?: string | null;
  /** Nombre de usuario público de WhatsApp, sin arroba. */
