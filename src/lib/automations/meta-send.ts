...
async function sendViaMeta(
  ...
  // whichever number happens to be the account default. An automation
  // that answers from a different number reads as a different company.
  ...
  try {
    ...
    throw err instanceof WhatsAppConfigError
